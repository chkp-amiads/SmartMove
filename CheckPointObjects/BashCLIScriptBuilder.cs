...
namespace CheckPointObjects
{
    ...
    /// </summary>
    public class BashCLIScriptBuilder : CLIScriptBuilder
    {

        private BashCLIScriptBuilder()
        {

        }

        public static BashCLIScriptBuilder bashCLIScriptBuilder;

        public static BashCLIScriptBuilder getInstance()
        {
            if (bashCLIScriptBuilder == null)
                bashCLIScriptBuilder = new BashCLIScriptBuilder();
            return bashCLIScriptBuilder;
        }
        ...
        public string GenerateRunCommandScript(string errorsReportFileName)
        {
            var sb = new StringBuilder();
